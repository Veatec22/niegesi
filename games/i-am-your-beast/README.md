...
Spolszczenie nie podmienia żadnego pliku gry. Żeby je usunąć, skasuj z katalogu gry folder `BepInEx` oraz pliki `winhttp.dll`, `doorstop_config.ini`, `.doorstop_version`, `BepInEx-LICENSE.txt` i `READ-ME.txt`.
