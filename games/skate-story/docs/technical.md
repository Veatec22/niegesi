...
(`translations/bible.yaml`), raport (`work/l10n-report.md`), lektura całej narracji
i dialogów, spis decyzji w `docs/translation-decisions.md`. Zmieniono 19 wpisów.
...
`work/gender-ru.py` porównuje formy rodzajowe RU z PL — tak znalazły się Beea
...
.venv\Scripts\python.exe games\skate-story\work\gender-ru.py
```
...
[Wcześniejsze rozpoznanie](../../../temp/research/2026-09-20-skate-story.md).
