...
.venv\Scripts\python.exe .claude\skills\lokalizacja\scripts\l10n_report.py gamespm
...
(`tools/patch.py`), `NieGesiPatch.exe` i `READ-ME.txt` z `docs/INSTALL.txt`.
...
1. Test pełnej wersji 1.0 i nazwy „Polski” na liście języków — punkty w
   `docs/decyzje-tlumaczenia.md`, sekcja „Mniej pewne”.
