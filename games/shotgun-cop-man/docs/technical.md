...
Pierwsza gra przejrzana skillem `.claude/skills/localization/`. Fakty i decyzje:
[`translations/bible.yaml`](../translations/bible.yaml), podsumowanie:
[`translation-decisions.md`](translation-decisions.md). Zmieniono 2 wpisy (Ofelia, Pedrowi); test w grze 0.3 czeka.
