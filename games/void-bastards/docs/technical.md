...
- Tłumaczenie według skilla `localization`: `translations/bible.yaml`
...
Standard: skill `localization`, biblia `translations/bible.yaml`, decyzje
`docs/translation-decisions.md`, raport `work/l10n-report.md` (czysty poza 18
