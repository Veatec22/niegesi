...
(`translations/bible.yaml`), raport kontrolny (`work/l10n-report.md`) i spis decyzji
(`docs/translation-decisions.md`). Zmieniono 210 wpisów, metoda dostarczania bez zmian.
