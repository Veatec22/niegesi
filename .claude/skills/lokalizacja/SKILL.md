...
1. **Biblia gry** — `games/<gra>/translations/biblia.yaml`, zanim zaczniesz
   tłumaczyć dialogi. Format i przykład: [BIBLIA.md](BIBLIA.md). Zawiera:
   ...
   Kolejność źródeł (pełna lista w [ZRODLA.md](ZRODLA.md)):
...
2. **Tłumaczenie** według biblii i [PULAPKI.md](PULAPKI.md): płeć mówiącego
...
3. **Raport kontrolny** po każdej większej partii i przed buildem:
   ```powershell
   .venv\Scripts\python.exe .claude\skills\lokalizacja\scripts\l10n_report.py games\<gra>
   ```
...
4. **Oddanie:** `games/<gra>/docs/decyzje-tlumaczenia.md` plus to samo
   w skrócie w odpowiedzi do użytkownika. Wzór: [ODDANIE.md](ODDANIE.md).
