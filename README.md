...
| [Neon Abyss](games/neon-abyss/) | 2639/2639 entries: menus, 600+ items, weapons, pets and sets, tips and lore, unlock tree, bosses, bar and office dialogue, seeds, cheat codes and achievements | 0.2.0 | BepInEx plugin adds Polish to I2 and to the hard-coded language switcher; Polish glyphs from the game's own fonts; vertical confirmed, full playthrough pending |
