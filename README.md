...
| [Neon Abyss](games/neon-abyss/) | 84/2639 entries (vertical sample): main menu, options, saves, difficulty, some characters, tutorials, items and bar dialogue | 0.1.0 | BepInEx plugin adds Polish to I2 and to the hard-coded language switcher; Polish glyphs from the game's own fonts; vertical confirmed in-game (auto-detects Polish Windows) |
